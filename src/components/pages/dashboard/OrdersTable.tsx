...
function getComparator(order:string, orderBy:string) {
  return order === 'desc' ? (a:string, b:string) => descendingComparator(a, b, orderBy) : (a, b) => -descendingComparator(a, b, orderBy);
}

function stableSort(array:Array<string>, comparator:(a:string, b:string) => Array ):number {
...
function OrderTableHead({ order, orderBy }:{order:string, orderBy: string}) {
  return (
    <TableHead>
      <TableRow>
